$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSchCoviSWYWtARXi32fpfySC2vHEKvPGXBZy4eIyu34hyD3vQ/formResponse");
                                ...
                                if (db1 != null)
                                    {
                                        ...
                                        //                                     {
                                                                                    ...
                                                                                    if (agree == true)
                                                                                    {
                                                                                        $('#send_message').css({transition:"1s"});
                                                                                        $('#send_message').prop("disabled", false);
                                                                                        $('#send_message').prop("value", "지금 신청하기");
                                        ...
                                        else
                                        {
                                            $('#send_message').css({transition:"1s"});
                                            $('#send_message').prop("disabled", true);
                                            $('#send_message').prop("value", "희망제품(2) 선택을 확인하세요.");
                                            $('#send_message').css({background:"#595959"});
                                            $('#send_message').css({cursor:"default"});        
                                        }            
                                    ...
                                    else
                                    {
                                        $('#send_message').css({transition:"1s"});
                                        $('#send_message').prop("disabled", true);
                                        $('#send_message').prop("value", "희망제품(1) 선택을 확인하세요.");
                                        $('#send_message').css({background:"#595959"});
                                        $('#send_message').css({cursor:"default"});        
                                    }
...
$(function(){
 $('#name,#phone,#loan,#age,#message,#agree11,#now-wg,#hope-wg,#height,#db1,#db2,#type,#warningCheck,#card').bind("keyup click change",form_check);
