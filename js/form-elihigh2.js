...
<div class="cd_font" style="text-align:-webkit-center;border:2px solid #000;border-radius:10px;width:93%;padding:10px 15px;max-width:450px;" > 
  ...
  <div class="hero" aria-label="만기 후 100% 환급 배너">
    ...
    <h1 class="form-top-title" style="color:red;font-weight: 600;font-size:140%;line-height:120%;">-원하시는 제품 체크 후<br><신청하기> 버튼을 눌러주세요.<br><br><span class="blink">* 외국인 신청 불가</span></h1>
    <h2 style="font-size:0.9rem;"><u>신청하신 개인정보는 오직 상담을 위해서만 사용되며,<br>상담 후 지체없이 폐기됩니다.</u></h2>
        ...
        <form action="" id="form_e12" method="POST" target="hidden_iframe12" onsubmit="dll(); submitted=true;">
         <input type="hidden" name="entry.2134610496" value="메타">
            ...
            <tr>
              ...
              <td>
                  <input type='text' name='entry.2031068747' id='phone1' class="form-control" placeholder="휴대폰번호" maxlength="11">
              </td>
          </tr>
